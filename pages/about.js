...
*/
export default function About({ posts, orderDesc, profilesProps }) {
  Utils.orderPageContent(orderDesc, posts.nodes);

  console.log('Profiles Props');
  console.dir(profilesProps);
...
export async function getStaticProps() {
  ...
  // let profileProps = await Backend.getBasicRequest('About Page Profile');
