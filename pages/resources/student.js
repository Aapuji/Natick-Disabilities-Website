    ...
    <Layout title="Student Resources" altText="... alt text goes here ..." hero>
      ...
      <div className={styles.studentsectioncontent}>
        ...
        <Hyperlink 
          ...
          desc = "The Federation has multiple initiatives to support, educate, and empower families and professionals around the education, health and community needs of children. These programs promote family engagement in all communities throughout Massachusetts. Our language line and Outreach team can help families requiring language assistance."
        />
        <Hyperlink 
          url = "https://www.massfamilyties.org/"
          name = "Family TIES of Massachusetts"
          desc = "Provides information and referral services, emotional support, and training to parents of children and youth with special needs. Family TIES is a primary source for information about Early Intervention and maintains a complete listing of Early Intervention Programs in MA."
        />
        <Hyperlink 
          url = "https://www.massadvocates.org/"
          name = "Mass Advocates for Families"
          desc = "Helps families navigate the special education system and provides practical resources."
        />
        <Hyperlink 
          ...
          desc = "Information about the kinds of behavioral health services available for children in Massachusetts, how to get those services, and how to pay for them. It also helps parents plan ahead for when their children “age out” of child services and health care payment programs."
        />
        <Hyperlink 
          url = "https://familyconnect.org/"
          name = "Family Connect"
          desc = "Resources for parents of children with visual impairments."
        />
        <Hyperlink 
          url = "https://thinkcollege.net/"
          name = "Think College, UMass Boston"
          desc = "Think College is dedicated to developing, expanding, and improving research and practice in inclusive higher education for students with intellectual disability."
        />
        <Hyperlink 
          ...
          desc = "A compilation of resources, guides, and reviews of in-state and out-of-state colleges."
        />
      </div>
    </Layout>
  </>;
